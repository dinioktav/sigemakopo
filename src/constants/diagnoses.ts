export interface DiagnosisNeed {
  id: string;
  title: string;
  causes: string[];
  signs: string[];
...
export const DENTAL_HYGIENE_DIAGNOSES: DiagnosisNeed[] = [
  {
    id: "protection_health_risk",
  ...
  {
    id: "biologically_sound_dentition",
  ...
  {
    id: "skin_mucous_membrane_integrity",
  ...
  {
    id: "conceptualization_problem_solving",
